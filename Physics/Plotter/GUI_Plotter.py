...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.enableLinearRegression.setText(_translate("MainWindow", "Regression Power"))
        ...
        self.label_4.setText(_translate("MainWindow", "Grid Color:"))
        self.pointTwo.setText(_translate("MainWindow", "Cross"))
        self.pointThree.setText(_translate("MainWindow", "Plus"))
        self.label_5.setText(_translate("MainWindow", "Point Type:"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("MainWindow", "Basic"))
        self.enableCustom.setText(_translate("MainWindow", "Customize Plot Size"))
        self.customSize.setTitle(_translate("MainWindow", "General"))
        ...
        self.shutDown.setText(_translate("MainWindow", "Quit"))
